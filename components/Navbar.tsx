...
const Navbar = () => {
  useEffect(() => {
    ...
    if (themeController) {
      ...
      (themeController as HTMLInputElement).checked = storedTheme === "light";

      themeController.addEventListener("change", () => {
        const theme = (themeController as HTMLInputElement).checked
          ? "light"
          : "dark";
    ...
    <div className="shadow-lg navbar bg-base-100">
      <SignedIn>
        <div className="navbar-start">
          ...
          <a href="/" className="text-xl btn btn-ghost">WebFlicks</a>
        </div>
      ...
      <SignedOut>
        ...
        <div className="flex items-center gap-3 navbar-end">
          ...
          <a href="/sign-up" className="btn-primary btn">
            Sign Up
          </a>
        </div>
      </SignedOut>
