...
const MovieDetailsPage: React.FC = () => {
    ...
    const [playingMovie, setPlayingMovie] = useState<boolean>(false);
    const [movieEmbedUrl, setMovieEmbedUrl] = useState<string>('');

    useEffect(() => {
        const pathParts = window.location.pathname.split('/');
        const movieId = parseInt(pathParts[pathParts.length - 1], 10);
        setId(movieId);
        ...
        const fetchMovieDetails = async () => {
            try {
                ...
                setMovie(movieData);
                setTrailer(trailerData.results.find((video: Video) => video.type === 'Trailer' && video.site === 'YouTube'));
    ...
    const handleWatchNow = () => {
        ...
        setMovieEmbedUrl(`https://vidsrc.to/embed/movie/${id}`);
    };
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="mt-12 lg:grid lg:gap-10 lg:grid-cols-4 sm:flex sm:flex-col">
                        <div className="col-span-1 p-4 rounded-md bg-base-300">
                            ...
                            <ul className="space-y-2">
                                {cast.slice(0, 5).map((actor: Cast, index: number) => (
                    ...
                    {playingMovie && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75">
                            <div className="relative z-10 w-full max-w-screen-full h-full">
                                <button
